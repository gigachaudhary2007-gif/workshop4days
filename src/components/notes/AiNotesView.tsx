        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7">
            {isLoading ? (
              ...
              <div className="bg-white rounded-2xl border border-dashed border-[#E1E5E1] p-8 text-center flex flex-col items-center justify-center min-h-[500px] text-[#89918C]">
                <div className="w-14 h-14 rounded-2xl bg-[#F8F9F6] border border-[#E1E5E1] flex items-center justify-center text-[#89918C] mb-3">
                  <FileText className="w-7 h-7" />
                </div>
                <h3 className="text-base font-bold text-[#171A18]">No Study Guide Selected</h3>
                <p className="text-xs text-[#5F6762] max-w-sm mt-1">
                  Input study material on the left or choose a pre-loaded sample to generate a complete structured study document.
                </p>
              </div>
            )}
          </div>
