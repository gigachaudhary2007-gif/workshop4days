...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed lg:static top-0 bottom-0 left-0 z-50 w-64 bg-white/65 backdrop-blur-2xl border-r border-white/80 flex flex-col justify-between transition-transform duration-200 ease-in-out shadow-[4px_0_30px_rgba(15,98,70,0.02)] ${
          isOpenMobile ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
        }`}
      >
        {/* Top Section: Logo & Brand */}
        <div>
          <div className="px-5 py-5 border-b border-white/80 flex items-center justify-between">
            <div
        ...
        <div className="p-3 border-t border-white/80 space-y-2 bg-white/40 backdrop-blur-md">
          {/* User Profile Pill */}
          <div
